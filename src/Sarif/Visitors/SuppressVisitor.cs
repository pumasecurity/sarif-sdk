...
namespace Microsoft.CodeAnalysis.Sarif.Visitors
{
    public class SuppressVisitor : SarifRewritingVisitor
    {
        ...
        public override Result VisitResult(Result node)
        {
            ...
            {
                if (this.resultsGuids.Contains(node.CorrelationGuid, StringComparer.OrdinalIgnoreCase) || (this.resultsGuids.Contains(node.Guid, StringComparer.OrdinalIgnoreCase)))
                {
