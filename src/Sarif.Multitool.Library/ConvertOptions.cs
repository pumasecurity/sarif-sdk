...
namespace Microsoft.CodeAnalysis.Sarif.Multitool
{
    ...
    public class ConvertOptions : SingleFileOptionsBase
    {
        [Option(
            't',
            "tool",
            HelpText = "The tool format of the input file. Must be one of: AndroidStudio, CisCat, ClangAnalyzer, ClangTidy, CppCheck, ContrastSecurity, FlawFinder, Fortify, FortifyFpr, FxCop, GenericSarif, Hdf, Nessus, PREfast, Pylint, SemmleQL, SnykLicense, SnykOpenSource, StaticDriverVerifier, TSLint, or a tool format for which a plugin assembly provides the converter.",
            Required = true)]
